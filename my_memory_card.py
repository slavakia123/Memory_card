...
questions_list.append(Question('Как зовут Гитлера?','Адольф','Алексей','Иосиф','Арнольд')) 
questions_list.append(Question('Какой гранаты нет в CS:SOURCE?','Зажигательной','Осколочной','Свето-шумовой','Дымовой'))
questions_list.append(Question('Какого персонажа нет в игре Portal 2?','Гордон Фримен','Чел','Уитли','Глэдос'))
questions_list.append(Question('Какой тип оружия не выпадает при убийстве Лунного Лорда?','Хлыст','Меч','Магический посох','Стрелковое оружие'))
questions_list.append(Question('Какого растения нет в Plants Versus Zombies 2,которое есть в первой части?','Ядерный гриб','Арабский гриб','Киргизский ландыш','Гипногриб'))
questions_list.append(Question('Какая карта из Clash Royal имеет больший урон(при условии,что у них одинаковый уровень)?','П.Е.К.К.А','Принц','Мегарыцарь','Пушка'))
questions_list.append(Question('Самая сильная шахматная фигура?','Ферзь','Конь','Слон','Ладья'))
app = QApplication([])
app.setStyle('Fusion')
